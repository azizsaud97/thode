...
<head>
    <title>استعادة كلمة المرور - ذود</title>
    <meta charset="utf-8">
    ...
    <style>
        ...
        .forgot-password-page { height: 100vh; display: flex; align-items: center; justify-content: center; }
            ...
            <div class="col-lg-6">
                <div class="bg-white shadow rounded p-4">
                    ...
                    <form action="{{ route('password.email') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100">إرسال رمز الاستعادة</button>
                    </form>
